window.onload = function () {
  ...
  animate();
  function init() {
    container = document.getElementById('observe-star-container');
    mouseX = 0;
    mouseY = 0;
    ...
    renderer.setSize(parseFloat($('#observe-star-container').css('width')), parseFloat($('#observe-star-container').css('height')));
